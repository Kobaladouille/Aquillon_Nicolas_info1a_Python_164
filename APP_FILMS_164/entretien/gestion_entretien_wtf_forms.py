"""Gestion des formulaires avec WTF pour les entretien
Fichier : gestion_entretien_wtf_forms.py
...
class FormWTFAddFilm(FlaskForm):
    ...
    submit = SubmitField("Enregistrer l'entretien")


class FormWTFUpdateFilm(FlaskForm):
    """
        Dans le formulaire "entretien_update_wtf.html" on impose que le champ soit rempli.
        Définition d'un "bouton" submit avec un libellé personnalisé.
    """

    nom_film_update_wtf = StringField("Entrez le garage où à été fait l'entretien", widget=TextArea())
    duree_film_update_wtf = IntegerField("Prix de l'entretien", validators=[NumberRange(min=1, max=5000,
...
class FormWTFDeleteFilm(FlaskForm):
    """
        Dans le formulaire "entretien_delete_wtf.html"
